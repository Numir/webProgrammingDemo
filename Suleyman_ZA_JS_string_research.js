...
let stDeger = "concat, endsWith, startsWith, includes, indexOf, lastIndexOf, padEnd, padStart, slice, split, subString, subStr, trim, trimEnd, trimStart, repeat, replace";
let stDeger2 = "Süleyman ders çalışıyor.";
